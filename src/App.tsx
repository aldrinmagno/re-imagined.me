...
import { Menu, X, ArrowRight, CheckCircle, TrendingUp, Map } from 'lucide-react';
      ...
      <nav className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="text-xl font-semibold text-slate-900">re-imagined.me</div>

            <div className="hidden md:flex space-x-8">
              <button onClick={() => scrollToSection('how-it-works')} className="text-slate-600 hover:text-slate-900 transition">
                How it works
              </button>
              <button className="text-slate-600 hover:text-slate-900 transition">About</button>
              <button className="text-slate-600 hover:text-slate-900 transition">Sign in</button>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 space-y-3 border-t border-slate-200">
              <button onClick={() => scrollToSection('how-it-works')} className="block w-full text-left text-slate-600 hover:text-slate-900 transition">
                How it works
              </button>
              <button className="block w-full text-left text-slate-600 hover:text-slate-900 transition">About</button>
              <button className="block w-full text-left text-slate-600 hover:text-slate-900 transition">Sign in</button>
            </div>
          )}
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <div className="flex gap-6 text-sm text-slate-600">
              <button className="hover:text-slate-900 transition">Privacy</button>
              <button className="hover:text-slate-900 transition">Terms</button>
